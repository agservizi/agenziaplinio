                    ...
                    <?php if (!empty($servicesMenu)): ?>
                        <div class="mega-panel" data-mega-panel>
                            ...
                            <div class="mega-grid">
                                <?php foreach ($servicesMenu as $service): ?>
                                    <a class="mega-card" href="<?php echo $service['key'] === 'payments' ? '?page=pagamenti-certificati' : '?page=home#servizi'; ?>" data-scroll>
                        ...
                        <div class="nav-mobile-services">
                            ...
                            <div class="nav-mobile-services__grid">
                                <?php foreach ($servicesMenu as $service): ?>
                                    <a class="nav-mobile-services__item" href="<?php echo $service['key'] === 'payments' ? '?page=pagamenti-certificati' : '?page=home#servizi'; ?>" data-scroll>
