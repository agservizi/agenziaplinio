...
// Debug temporaneo
if (!empty($digitalCustomFields)) {
    echo '<pre>Debug custom fields: ' . htmlspecialchars(json_encode($digitalCustomFields, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE)) . '</pre>';
}
$italianProvinces = [
