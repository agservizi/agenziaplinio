const App = (() => {
    ...
    function getPredefinedResponse(question, isLoggedIn) {
        ...
        if ((normalized.includes('non ricordo pin') || normalized.includes('sim chiede pin') || normalized.includes('inserito pin tre volte') || normalized.includes('pin bloccata')) && normalized.includes('iliad')) {
