            ...
            <div class="ap-chatbot__tab-content" data-chatbot-tab-content="chat">
                <div class="ap-chatbot__messages" data-chatbot-messages role="log" aria-live="polite">
                    <div class="ap-chatbot__message ap-chatbot__message--bot">
                        <p>Ciao! Sono Plinio, l'assistente virtuale di AG SERVIZI VIA PLINIO 72. Come posso aiutarti con pagamenti bollettini, ricariche, attivazioni SPID/PEC, firme digitali, spedizioni o servizi WindTre/Fastweb/Iliad?</p>
                    </div>
                </div>
